...
>
    <v-card class="project-container">
        ...
        <div class="section-content">
            ...
            La majorité est gratuite tandis que d'autres peuvent exiger des frais d'accès. Certains peuvent être privés et internes à votre organisation.
        ...
        <div class="section-content">
            ...
            Même sans compétences de codage, les utilisateurs peuvent créer des procédures pas à pas et des messages intégrés à l'application pour accueillir leurs clients.
            ...
            Nous avons profité de la refonte du tutoriel pour intégrer quelques changements :
                <br>- Côté client : la possibilité de revenir à une étape précédente
                <br>- Côté serveur : le contenu du tutoriel serait stocké en base de données pour permettre aux personnes de l’équipe de modifier son contenu sans toucher au code
        </div>
        <div>
            <img class="" src="@/assets/images/projects/apx/maquetteStep.png"/>
        </div>
        <!-- CONCLUSION -->
        <div class="section-title">
            Conclusion
        ...
        <div class="section-content">
            Cette mission était la longue et la plus important que j’ai eu à réaliser durant mon stage.
            Elle m’aura demandé beaucoup d’autonomie, mais aussi beaucoup de temps pour comprendre le code existant et m’y adapter.
            Au final, on se retrouve côté interne avec un tutoriel plus facilement maintenable, qui permet de modifier le contenu des étapes sans passer par le code grâce à une base de données et qui n’est plus dépendant d’Appcues.
